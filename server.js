const http = require('http'); // objet http qui permet de créer un serveur
const app = require('./app');// on fait importe app.js
// lancer le serveur avec nodemon serveur pour avoir le site actualisé 
